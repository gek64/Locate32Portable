...
user in an INI file next to Locate32Portable.exe called Locate32Portable.ini.
...
copy AppNamePortable.ini from this directory to Locate32Portable.ini next to
Locate32Portable.exe. The options in the INI file are as follows:
